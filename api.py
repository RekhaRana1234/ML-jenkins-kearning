...
#MODEL_DIR = os.environ["/home/rekha/Online_inference"]
#MODEL_FILE_LDA = os.environ["clf_lda"]
#MODEL_FILE_NN = os.environ["clf_nn"]
#MODEL_PATH_LDA = os.path.join(MODEL_DIR, MODEL_FILE_LDA)
#MODEL_PATH_NN = os.path.join(MODEL_DIR, MODEL_FILE_NN)

# Loading LDA model
#print("Loading model from: {}".format(MODEL_PATH_LDA))
inference_lda = load('inference_lda.joblib')

# loading Neural Network model
#print("Loading model from: {}".format(MODEL_PATH_NN))
inference_NN = load('inference_nn.joblib')
